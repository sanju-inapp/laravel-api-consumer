...
namespace SanjuInapp\ApiConsumer;
...
class Router {
    ...
    {
        return $this->quickCall('GET', $args);
    }
    ...
    {
        return $this->quickCall('POST', $args);
    }
    ...
    {
        return $this->quickCall('PUT', $args);
    }
    ...
    {
        return $this->quickCall('DELETE', $args);
    }
    ...
    public function batchRequest(array $requests)
    {
        foreach ($requests as $i => $request) {
            $requests[$i] = $this->singleRequest(...$request);
        }
    ...
    public function quickCall($method, array $args)
    {
        ...
        return $this->singleRequest(...$args);
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function singleRequest(string $method, string $uri, array $data = [], array $headers = [], ?string $content = null)
    {
     ...
     * @return \Illuminate\Http\Response
     */
    private function request(string $method, string $uri, array $data = [], array $headers = [], ?string $content = null)
    {
     ...
     */
    private function createRequest(string $method, string $uri, array $data = [], array $headers = [], ?string $content = null)
    {
